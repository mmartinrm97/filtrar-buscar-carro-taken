...
//Event listener para los select de búsquda
...
function mostrarAutos( autos ){
    ...
    autos.forEach(auto => {
        ...
        autoHTML.textContent = `
            ${marca} - ${modelo} - ${year} - Puertas: ${puertas} - Transmsión: ${transmision} - Precio: ${precio} - Color: ${color};
        `;

        //Insetar resultado en el HTML
